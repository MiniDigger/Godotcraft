namespace Godotcraft.scripts {
public class Actions {

	public static readonly string console_open = "console_open";
	public static readonly string console_close = "console_close";
	
	public static readonly string movement_strafe_left = "movement_strafe_left";
	public static readonly string movement_strafe_right = "movement_strafe_right";
